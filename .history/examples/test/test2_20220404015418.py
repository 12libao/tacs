...
# [asa, work] = pyamg.aggregation.adaptive_sa_solver(A0, num_candidates=1)
# print(asa)
print(ml)
...
# x = asa.solve(b=np.ones((A0.shape[0],)), x0=np.ones((A0.shape[0],)), residuals=residuals, accel='cg')
# # x = asa.solve(b=np.ones((A0.shape[0],)), x0=np.ones(
#     (A0.shape[0],)), residuals=residuals)
