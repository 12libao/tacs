...
# geo = TMR.LoadModel('airfoil_39_3d.stp')
geo = TMR.LoadModel('airfoil_39_3d.stp')
vols = geo.getVolumes()
faces = geo.getFaces()
edges = geo.getEdges()
...
def create_forest(comm, depth, htarget=5.0, filename='airfoil_39_3d.stp'):
    """
...
assembler = create_problem(forest, bcs, props, nlevels)

# Create the multigrid object
mg = TMR.createMg(assembler, forest, omega=0.5)
...
if __name__ == '__main__':
    ...
    for step in range(max_iterations):
        ...
        if density_based_refine:
            ...
            TopOptUtils.densityBasedRefine(
                forest, assembler, lower=0.05, upper=0.5)
        else:
